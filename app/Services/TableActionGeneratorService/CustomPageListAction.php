...
class CustomPageListAction extends GeneratorService implements Generator
{
    private static ?CustomPageListAction $instance = null;

    protected CustomPage $customPage;
    public function __construct(){}

    public static function getInstance(mixed $customPage): Generator
    {
        if(self::$instance == null)
            self::$instance = new self();

        self::$instance->set($customPage);
    ...
    {
        $editTo = route("customPageAddEdit", $this->customPage->id);
        $deleteTo = route("customPageDelete", $this->customPage->id);
