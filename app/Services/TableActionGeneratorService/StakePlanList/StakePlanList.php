...
namespace App\Services\TableActionGeneratorService\StakePlanList;
use App\Models\StakePlan;
use App\Services\TableActionGeneratorService\Generator;
use App\Services\TableActionGeneratorService\GeneratorService;

class StakePlanList extends GeneratorService implements Generator
{
    public static ?StakePlanList $instance = null;
    protected StakePlan $stakePlan;
    public function __construct(){}

    public static function getInstance(mixed $stakePlan): Generator
    {
        if(self::$instance == null)
            self::$instance = new self();

        self::$instance->set($stakePlan);
    ...
    {
        $editTo   = route("editStakePlan", $this->stakePlan->id);
        $deleteTo = route("deleteStakePlan", $this->stakePlan->id);
