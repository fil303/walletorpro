...
@section('content')
    ...
    <!-- About Section -->
    <section class="relative min-h-screen py-5 bg-slate-900" id="about">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="relative">
                        ...
                        <div class="relative z-20 bg-opacity-10 p-2 rounded-2xl">
                            <img src="{{ $landing->about_section_image ?? asset('assets/img/about-hero.png') }}" 
                                alt="About Us" 
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="w-full lg:w-1/2 space-y-8">
                    <div class="relative">
                        <!-- Main Image -->
                        <div class="relative z-20 bg-opacity-10 p-2 rounded-2xl">
                            <img src="{{ $landing->service_section_image ?? asset('assets/img/about-hero.png') }}" 
                                alt="About Us" 
                                class="rounded-xl w-full">
                        </div>
    ...
    <section class="relative py-5 bg-slate-900" id="how-it-works">
        <div class="container mx-auto px-6">
            <h2 class="text-4xl font-bold text-center mb-4 text-[var(--primary)]">{{ $landing->how_section_title ?? "How It
                Works" }}</h2>
                ...
                <div class="splide__track">
                    <div class="splide__list">
                        ...
                        <div class="splide__slide mb-20">
                            ...
                            <div class="relative">
                                <div
                                    class="absolute top-1/2 left-0 w-full h-1 bg-[var(--primary)]/10 -translate-y-1/2 hidden lg:block">
                                </div>
                                <div class="grid lg:grid-cols-3 gap-8">
                                    <div class="group relative">
                                        <div
                                            class="absolute inset-0 bg-gradient-to-r from-[var(--secondary)] to-[var(--info)] opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-300">
                                        </div>
                                        <div
                                            class="relative bg-[var(--primary)] bg-opacity-10 rounded-2xl p-8 hover:transform hover:scale-105 transition-all">
                                            <div
                                                class="w-16 h-16 bg-[var(--secondary)] rounded-xl flex items-center justify-center mb-6">
                                                <span class="text-xl font-bold text-black">01</span>
                                            </div>
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_step1_title ?? "Select Coin" }}</h4>
                                            <p class="text-[var(--info)]">{{ $landing->how_section_step1_description ??
                                                "Choose the cryptocurrency you want to buy or sell" }}</p>
                                        </div>
                                    </div>
                                    <div class="group relative">
                                        <div
                                        ...
                                        <div
                                            class="relative bg-[var(--primary)] bg-opacity-10 rounded-2xl p-8 hover:transform hover:scale-105 transition-all">
                                            <div
                                                class="w-16 h-16 bg-[var(--info)] rounded-xl flex items-center justify-center mb-6">
                                                <span class="text-xl font-bold text-white">02</span>
                                            </div>
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_step2_title ?? "Enter Amount" }}</h4>
                                            <p class="text-[var(--info)]">{{ $landing->how_section_step2_description ??
                                                "Specify the amount and choose payment method" }}</p>
                                        </div>
                                    </div>
                                    <div class="group relative">
                                        <div
                                        ...
                                        <div
                                            class="relative bg-[var(--primary)] bg-opacity-10 rounded-2xl p-8 hover:transform hover:scale-105 transition-all">
                                            <div
                                                class="w-16 h-16 bg-[var(--success)] rounded-xl flex items-center justify-center mb-6">
                                                <span class="text-xl font-bold text-white">03</span>
                                            </div>
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_step3_title ?? "Complete Transaction" }}</h4>
                                            <p class="text-[var(--info)]">{{ $landing->how_section_step3_description ??
                                                "Confirm and receive coins in your wallet" }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid lg:grid-cols-3 gap-8">
                                    <div class="group relative">
                                        ...
                                        <div
                                            ...
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_staking_step1_title ?? "Choose Staking Plan"}}</h4>
                                            <p class="text-[var(--info)]">{{ $landing->how_section_staking_step1_description
                                                ?? "Select from available coins and durations"}}</p>
                                        </div>
                                    </div>
                                    <div class="group relative">
                                        <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_staking_step2_title ?? "Lock Period"}}</h4>
                                            <p class="text-[var(--info)]">{{ $landing->how_section_staking_step2_description
                                                ?? "Lock your assets for the chosen duration"}}</p>
                                        </div>
                                    </div>
                                    <div class="group relative">
                                        <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_staking_step3_title ?? "Earn Rewards"}}</h4>
                                            <p class="text-[var(--info)]">{{ $landing->how_section_staking_step3_description
                                                ?? "Receive staking rewards after completion"}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid lg:grid-cols-3 gap-8">
                                    <div class="group relative">
                                        ...
                                        <div
                                            ...
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_exchange_step1_title ?? "Select Pairs"}}</h4>
                                            <p class="text-[var(--info)]">{{
                                                $landing->how_section_exchange_step1_description ?? "Choose the
                                                cryptocurrencies to exchange"}}</p>
                                        </div>
                                    </div>
                                    <div class="group relative">
                                        <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_exchange_step2_title ?? "View Rate"}}</h4>
                                            <p class="text-[var(--info)]">{{
                                                $landing->how_section_exchange_step2_description ?? "Check live exchange
                                                rates"}}</p>
                                        </div>
                                    </div>
                                    <div class="group relative">
                                        ...
                                        <div
                                            ...
                                            <h4 class="text-2xl font-bold text-white mb-4">{{
                                                $landing->how_section_exchange_step3_title ?? "Confirm Swap"}}</h4>
                                            <p class="text-[var(--info)]">{{
                                                $landing->how_section_exchange_step3_description ?? "Complete the exchange
                                                securely"}}</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @foreach ($testimonials ?? [] as $testimonial)
                            <div class="splide__slide px-4">
                                <div class="bg-[var(--primary)] bg-opacity-10 rounded-2xl p-8 relative">
                                    <div class="absolute -top-4 -right-4 w-12 h-12 bg-[var(--secondary)] rounded-full flex items-center justify-center">
                                        <svg class="w-6 h-6 text-black" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M14.417 6.679C15.447 7.773 16 9.289 16 10.989c0 3.5-2.457 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621-.537.278-1.24.375-1.929.311-1.804-.167-3.226-1.648-3.226-3.489a3.5 3.5 0 013.5-3.5c1.073 0 2.099.49 2.748 1.179zm-10 0C5.447 7.773 6 9.289 6 10.989c0 3.5-2.457 6.637-6.03 8.188l-.893-1.378c3.335-1.804 3.987-4.145 4.247-5.621-.537.278-1.24.375-1.929.311C-.409 12.322-2 10.841-2 9a3.5 3.5 0 013.5-3.5c1.073 0 2.099.49 2.748 1.179z"></path>
                                        </svg>
                                    </div>
                                    <p class="text-[var(--info)] text-lg mb-6">"{{ $testimonial->feedback ?? '' }}"</p>
                                    <div class="flex items-center gap-4">
                                        <img src="{{ $testimonial->getImage() }}"  alt="Client" class="w-12 h-12 rounded-full" loading="lazy">
                                        <div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="relative">
                        <!-- Main Image -->
                        <div class="relative z-20 bg-opacity-10 p-2 rounded-2xl">
                            <img src="{{ $landing->faq_section_image ?? asset('assets/img/about-hero.png') }}" 
                                alt="About Us" 
                                class="rounded-xl w-full">
                        </div>
                    ...
                    <div class="max-w-3xl mx-auto space-y-4" x-data="{ selected: null }">
                        ...
                        @foreach ($faqs ?? [] as $faq)
                            <div class="bg-[var(--primary)] bg-opacity-10 rounded-2xl overflow-hidden">
                                <button 
                                    @click="selected !== {{ $faq->id ?? 1 }} ? selected = {{ $faq->id ?? 1 }} : selected = null"
                                ...
                                >
                                    ...
                                    <svg 
                                        ...
                                        :class="{ 'rotate-180': selected === {{ $faq->id ?? 1 }} }"
                                        fill="none" 
                                        stroke="currentColor" 
                                        viewBox="0 0 24 24"
                                    >
