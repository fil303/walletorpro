...
<div class="container mx-auto p-6 space-y-8">
    ...
    <div class="card bg-base-100">
        <div class="card-body">
            @include('admin.dashboard.summary_cards')
        </div>
    </div>
    ...
    <div class="grid sm:block grid-cols-2 md:grid-cols-1 gap-6">
        ...
        <div class="card bg-base-100 shadow-lg p-6 sm:mb-6">
            <h2 class="card-title">{{ __('User Growth') }}</h2>
    ...
    @if (isset($deposit_reports[0]))
        <div class="card bg-base-100 shadow-lg p-4 mt-6">
            <div class="flex justify-between">
                ...
                <a href="{{ route('depositPage') }}" class="btn btn-xs hover:bg-white/20">{{ __('View More') }} →</a>
            </div>
    ...
    @if (isset($pending_withdrawal_reports[0]))
        <div class="card bg-base-100 shadow-lg p-4 mt-4">
            <div class="flex justify-between">
                ...
                <a href="{{ route('withdrawalPage') }}" class="btn btn-xs hover:bg-white/20">{{ __('View More') }} →</a>
            </div>
            <div class="overflow-x-auto">
                <table class="table w-full">
                    <thead>
    ...
    @if (isset($pending_ticket_reports[0]))
        <div class="card bg-base-100 shadow-lg p-4 mt-4">
            <div class="flex justify-between">
                ...
                <a href="{{ route('adminTicketsPending') }}" class="btn btn-xs hover:bg-white/20">{{ __('View More') }} →</a>
            </div>
            <div class="overflow-x-auto">
                <table class="table w-full">
                    <thead>
