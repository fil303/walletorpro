<div class="grid sm:block grid-cols-3 md:grid-cols-2 gap-6">
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Total Users") }}</h2>
                <p class="text-2xl font-bold">{{ $total_users ?? 0 }}</p>
            </div>
        ...
        <div class="flex justify-end">
            <a href="{{ route('activeUserList') }}" class="btn btn-xs btn-ghost text-white hover:bg-white/20">{{ __('View More') }} →</a>
        </div>
    </div>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Active Users") }}</h2>
                <p class="text-2xl font-bold">{{ $active_users ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Active Coins") }}</h2>
                <p class="text-2xl font-bold">{{ $active_coins ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        ...
        <div class="flex justify-end">
            <a href="{{ route('depositPage') }}" class="btn btn-xs btn-ghost text-white hover:bg-white/20">{{ __('View More') }} →</a>
        </div>
    </div>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Total Tickets") }}</h2>
                <p class="text-2xl font-bold">{{ $total_ticket ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="flex justify-end">
            <a href="{{ route('adminTicketsIndex') }}" class="btn btn-xs btn-ghost text-white hover:bg-white/20">{{ __('View More') }} →</a>
        </div>
    </div>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Open Tickets") }}</h2>
                <p class="text-2xl font-bold">{{ $open_ticket ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/><path d="M13 5v2"/><path d="M13 17v2"/><path d="M13 11v2"/>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Closed Tickets") }}</h2>
                <p class="text-2xl font-bold">{{ $closed_ticket ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/><path d="M13 5v2"/><path d="M13 17v2"/><path d="M13 11v2"/>
        ...
        <div class="flex justify-end">
            <a href="{{ route('adminTicketsClosed') }}" class="btn btn-xs btn-ghost text-white hover:bg-white/20">{{ __('View More') }} →</a>
        </div>
    </div>
    @endif
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Coin Exchanged") }}</h2>
                <p class="text-2xl font-bold">{{ $total_exchange ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/>
        ...
        <div class="flex justify-end">
            <a href="{{ route('coinExchangeReport') }}" class="btn btn-xs btn-ghost text-white hover:bg-white/20">{{ __('View More') }} →</a>
        </div>
    </div>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-2xl font-bold">{{ $total_purchase ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Pending Withdrawal") }}</h2>
                <p class="text-2xl font-bold">{{ $pending_withdraw ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M12 2a10 10 0 0 1 7.38 16.75"/><path d="m16 12-4-4-4 4"/><path d="M12 16V8"/><path d="M2.5 8.875a10 10 0 0 0-.5 3"/><path d="M2.83 16a10 10 0 0 0 2.43 3.4"/><path d="M4.636 5.235a10 10 0 0 1 .891-.857"/><path d="M8.644 21.42a10 10 0 0 0 7.631-.38"/>
        ...
        <div class="flex justify-end">
            <a href="{{ route('withdrawalPendingList') }}" class="btn btn-xs btn-ghost text-white hover:bg-white/20">{{ __('View More') }} →</a>
        </div>
    </div>
    ...
    <div class="card bg-gradient-to-r to-primary from-accent text-white shadow-lg p-4 sm:mb-6">
        <div class="flex justify-between items-start">
            <div>
                <h2 class="text-sm font-semibold">{{ __("Total Staking") }}</h2>
                <p class="text-2xl font-bold">{{ $total_staking ?? 0 }}</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 lucide lucide-bitcoin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
