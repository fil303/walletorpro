<header class="fixed top-0 header_width sm:w-full shadow z-10 bg-base-100">
    <nav class="border-gray-200 px-4 lg:px-6 py-2.5">
        <div class="flex flex-wrap justify-between items-center">
            <div class="">
                <button id="sidebar_toggle_button" type="button"
                    class="inline-flex items-center p-2 ml-1 text-sm rounded-lg focus:outline-none focus:ring-2">
                    <span class="sr-only"></span>
                    <svg id="sidebar_toggle_button_on" class="hidden w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                            clip-rule="evenodd"></path>
                    </svg>
                    <svg id="sidebar_toggle_button_off" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
            ...
            <!-- <div class="sm:block hidden">
                <button id="sidebar_toggle_button" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" >
            ...
            <div class="flex items-center relative">
                ...
                <button type="button" id="profile_dropdown_button" data-dropdown-toggle="profile_dropdown"
                    ...
                    <div class="mr-2">
                        <img class="w-10 h-10 rounded-full object-cover object-right" loading="lazy"
                ...
                <div id="profile_dropdown"
                    class="z-50 hidden absolute top-10 right-10 w-full max-w-sm rounded-lg bg-white p-3 drop-shadow-xl divide-y divide-gray-200">
                    <div aria-label="header" class="flex space-x-4 items-center p-4">
                        <div aria-label="avatar" class="flex mr-auto items-center space-x-4">
                            <img src="https://avatars.githubusercontent.com/u/499550?v=4" alt="avatar Evan You"
                                class="w-16 h-16 shrink-0 rounded-full" loading="lazy" />
                                        ...
                                        <span class="truncate relative pr-8">
                                            ...
                                            <span aria-label="verified"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                                    class="w-6 h-6 ml-1 text-cyan-400" width="24" height="24"
                    ...
                    <div aria-label="navigation" class="py-2">
                        <nav class="grid gap-1">
                            <a href="{{ route('adminProfilePage') }}"
                                ...
                                <img src="{{ asset_bind('assets/svg/user-outline.svg') }}" alt="" srcset="" loading="lazy">
                                <span>Profile</span>
                            </a>
                            <a id="light_mode_button" href="#"
                                class="flex items-center leading-6 space-x-3 py-3 px-4 w-full text-lg text-gray-600 focus:outline-none hover:bg-gray-100 rounded-md"
                                data-theme-name="pastel" onclick="changeTheme(this)">
                                <span class="icon-[line-md--sun-rising-filled-loop]"
                                    style="width: 24px; height: 24px; color: #f9f06b;"></span>
                                <span>{{ __('Light Mode') }}</span>
                            </a>
                            <a id="dark_mode_button" href="#"
                                class="flex items-center leading-6 space-x-3 py-3 px-4 w-full text-lg text-gray-600 focus:outline-none hover:bg-gray-100 rounded-md"
                                data-theme-name="night" onclick="changeTheme(this)">
                                <span class="icon-[line-md--sunny-filled-loop-to-moon-filled-loop-transition]"
                                    style="width: 24; height:24; color: #77767b;"></span>
                                <span>{{ __('Dark Mode') }}</span>
                            </a>

                            <a href="#"
                                class="flex items-center leading-6 space-x-3 py-3 px-4 w-full text-lg text-gray-600 focus:outline-none hover:bg-gray-100 rounded-md">
                                <img src="{{ asset_bind('assets/svg/guide.svg') }}" alt="" srcset="" loading="lazy">
                                <span>Guide</span>
                            </a>
                            <a href="#"
                                class="flex items-center leading-6 space-x-3 py-3 px-4 w-full text-lg text-gray-600 focus:outline-none hover:bg-gray-100 rounded-md">
                                <img src="{{ asset_bind('assets/svg/helper_center.svg') }}" alt="" loading="lazy"
                                    srcset="">
                    ...
                    <div aria-label="footer" class="pt-2">
                        <button type="button"
                            ...
                            <img src="{{ asset_bind('assets/svg/logout.svg') }}" alt="" srcset="" loading="lazy">
                            <span>Logout</span>
                        </button>
                    </div>
                </div>
