        ...
        <div class="card sm:w-[99%] w-[40%] bg-base-100 shadow-xl ">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <h2 class="text-2xl font-bold">{{ __("Account Login") }}</h2>
                ...
                <form action="{{ route('login') }}" method="post" class="space-y-4">@csrf
                    ...
                    <div class="form-control w-full mt-4">
                        ...
                        <span class="label-text">
                            <a href="{{ route('forgotPasswordPage') }}" class="link link-primary">{{__("Forgot Password")}}</a>
                        </span>
                        </label>
                        <div class="relative">
                ...
                @if(false)
                    ...
                    <div class="flex justify-center space-x-4">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg" alt="Facebook" loading="lazy" class="h-6 w-6">
                        </button>
                        <button class="btn btn-circle btn-outline">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg" alt="Facebook" loading="lazy" class="h-6 w-6">
                        </button>
